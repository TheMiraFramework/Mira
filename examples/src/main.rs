use mira_core::attention::{Attention, AttentionConfig};
use mira_core::knowledge::Document;
use clap::{command, Parser};
use rig::providers::{self, openai};

use mira_core::character;
use mira_core::init_logging;
use mira_core::knowledge::KnowledgeBase;
use mira_core::loaders::github::GitLoader;
use mira_core::{agent::Agent, clients::discord::DiscordClient};
